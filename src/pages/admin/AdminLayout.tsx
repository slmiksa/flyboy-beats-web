...
const AdminLayoutContent = () => {
  ...
  if (loading || isVerifying) {
    return <div className="min-h-screen flex items-center justify-center bg-flyboy-dark">
      ...
      <div className="flex h-screen bg-flyboy-dark">
        <Sidebar>
          ...
          <SidebarContent className="p-0 bg-flyboy-dark">
            <SidebarMenu>
              <SidebarMenuItem>
                <SidebarMenuButton tooltip="لوحة التحكم" onClick={() => navigate("/admin")} className="hover:bg-flyboy-purple/50 text-white">
                  <LayoutDashboard className="ml-3 text-flyboy-gold" />
                  <span>الرئيسية</span>
                </SidebarMenuButton>
              </SidebarMenuItem>
              <SidebarMenuItem>
                <SidebarMenuButton tooltip="السلايدات" onClick={() => navigate("/admin/slides")} className="hover:bg-flyboy-purple/50 text-white">
                  <Image className="ml-3 text-flyboy-gold" />
                  <span>السلايدات</span>
                </SidebarMenuButton>
              </SidebarMenuItem>
              <SidebarMenuItem>
                <SidebarMenuButton tooltip="الحفلات" onClick={() => navigate("/admin/events")} className="hover:bg-flyboy-purple/50 text-white">
                  <CalendarDays className="ml-3 text-flyboy-gold" />
                  <span>الحفلات</span>
                </SidebarMenuButton>
              </SidebarMenuItem>
              <SidebarMenuItem>
                <SidebarMenuButton tooltip="الشركاء" onClick={() => navigate("/admin/partners")} className="hover:bg-flyboy-purple/50 text-white">
                  <Users className="ml-3 text-flyboy-gold" />
                  <span>شركاء النجاح</span>
                </SidebarMenuButton>
              </SidebarMenuItem>
              <SidebarMenuItem>
                <SidebarMenuButton tooltip="نبذة عني" onClick={() => navigate("/admin/about")} className="hover:bg-flyboy-purple/50 text-white">
                  <FileText className="ml-3 text-flyboy-gold" />
                  <span>نبذة عني</span>
                </SidebarMenuButton>
              </SidebarMenuItem>
              {adminUser?.is_super_admin && <SidebarMenuItem>
                  <SidebarMenuButton tooltip="المستخدمين" onClick={() => navigate("/admin/users")} className="hover:bg-flyboy-purple/50 text-white">
          ...
          <SidebarFooter className="border-t border-flyboy-gold/30 p-4 bg-flyboy-dark">
            <div className="flex w-full items-center justify-between">
              ...
              <Button variant="outline" size="sm" onClick={handleLogout} className="h-9 gap-2 border-flyboy-gold text-flyboy-gold hover:bg-flyboy-purple hover:text-white">
