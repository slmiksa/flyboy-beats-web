        ...
        <Sidebar side="right" variant="sidebar" className={cn("transition-all duration-300 ease-in-out", sidebarCollapsed ? "md:w-[60px]" : "")}>
          ...
          <SidebarContent className="py-2 bg-flyboy-purple/90">
            <SidebarMenu className="space-y-2 px-3">
              <SidebarMenuItem>
                <SidebarMenuButton onClick={() => navigate("/admin")} isActive={isRouteActive("/admin")} tooltip="الرئيسية" className={cn("hover:bg-flyboy-purple/60", isRouteActive("/admin") ? "bg-flyboy-purple" : "")}>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton onClick={() => navigate("/admin/slides")} isActive={isRouteActive("/admin/slides")} tooltip="السلايدات" className={cn("hover:bg-flyboy-purple/60", isRouteActive("/admin/slides") ? "bg-flyboy-purple" : "")}>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton onClick={() => navigate("/admin/events")} isActive={isRouteActive("/admin/events")} tooltip="الحفلات" className={cn("hover:bg-flyboy-purple/60", isRouteActive("/admin/events") ? "bg-flyboy-purple" : "")}>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton onClick={() => navigate("/admin/partners")} isActive={isRouteActive("/admin/partners")} tooltip="شركاء النجاح" className={cn("hover:bg-flyboy-purple/60", isRouteActive("/admin/partners") ? "bg-flyboy-purple" : "")}>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton onClick={() => navigate("/admin/about")} isActive={isRouteActive("/admin/about")} tooltip="نبذة عنا" className={cn("hover:bg-flyboy-purple/60", isRouteActive("/admin/about") ? "bg-flyboy-purple" : "")}>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton onClick={() => navigate("/admin/social-media")} isActive={isRouteActive("/admin/social-media")} tooltip="منصات التواصل" className={cn("hover:bg-flyboy-purple/60", isRouteActive("/admin/social-media") ? "bg-flyboy-purple" : "")}>
              ...
              {adminUser?.is_super_admin && <SidebarMenuItem>
                  <SidebarMenuButton onClick={() => navigate("/admin/users")} isActive={isRouteActive("/admin/users")} tooltip="المستخدمين" className={cn("hover:bg-flyboy-purple/60", isRouteActive("/admin/users") ? "bg-flyboy-purple" : "")}>
          ...
          <SidebarFooter className="border-t border-flyboy-gold/20 p-4 bg-flyboy-purple">
            <Button onClick={handleLogout} className="w-full bg-flyboy-purple hover:bg-flyboy-purple/80 text-white border border-flyboy-gold/30">
