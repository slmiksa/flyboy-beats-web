...
const AdminSocialMedia = () => {
  ...
  const onSubmit = async (values: any) => {
    try {
      ...
      if (result.error) {
        console.error('Error saving social media link:', result.error);
        throw result.error;
      }
      ...
      toast({
        title: "خطأ",
        description: `حدث خطأ أثناء حفظ الرابط: ${error.message}`,
        variant: "destructive"
      });
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      ...
      toast({
        title: "خطأ",
        description: `حدث خطأ أثناء حذف الرابط: ${error.message}`,
        variant: "destructive"
      });
  ...
  const moveOrder = async (link: SocialMedia, direction: 'up' | 'down') => {
    try {
      ...
      if (error1 || error2) {
        console.error('Error reordering social media links:', error1 || error2);
        throw error1 || error2;
      }
      ...
      toast({
        title: "خطأ",
        description: `حدث خطأ أثناء تغيير ترتيب الروابط: ${error.message}`,
        variant: "destructive"
      });
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input 
                          ...
                          placeholder="https://..." 
                          {...field} 
                          className="bg-flyboy-purple/30 border-flyboy-gold/30 text-white"
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
